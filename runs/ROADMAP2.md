...
| 15 | Mixed data: Leela + Stockfish binpacks, 800 SB (runs/anna-v5/PLAN.md) | **+54 +/- 30 per node over v3b at SB 670 (cap hit before the end)** | ~$10.7 Modal | **the lever that works: v5-670 blitz +26 +/- 13 (976 games); finished v5f +78 +/- 30 per node over v3b**; default net on main (1.1-dev); slow-control test running |
