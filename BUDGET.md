...
Account credit on 2026-09-10: **$9.86** (vast.ai, liron account). Spent so far: **$9.27** (fable-v1 $1.87, anna-v3 $3.50, cpu-eval $0.20, anna-v3b $1.10, cpu-eval2 $0.27, anna-v4 $1.62, cpu-eval3 $0.71). Remaining: **$0.59** (credit read from the account 2026-09-13 17:58). Modal (separate, owner's $30/month credit): anna-v3c ~$6.
