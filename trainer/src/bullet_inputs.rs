//! Verbatim copy of bullet examples/advanced/inputs.rs (rev 629ee50) minus the model mapper,
//! used only to cross-check the engine's threat/pawn-pair feature indices.
#![allow(dead_code)]
use std::sync::Arc;
