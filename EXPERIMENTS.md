...
| anna-v3c | v3b resumed (weights + Adam state) for 430 SB on six months (Apr, Jun added) + 30 SB WDL, restart LR 5e-4, L40S on Modal | ~$6 Modal credit | **equal nodes vs v3b: +19 +/- 32** (200 games, 52.75%); midway s1-170 was -78 (mid-anneal) | small positive, not resolved; 400 more games running. Lesson: v3b was closer to converged than v1@340 (threat inputs learn faster), so "train longer" is worth far less here than on v1; a gentler restart (1e-4) may do better |
