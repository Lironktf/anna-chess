...
| anna-v5 | v3b architecture (L1 512) on Leela Jan-Jun 2024 + Stockfish dfrc_n5000 + nodes5000pv2_UHO (139 GB, sources interleaved in the file order), 800 SB (30/740/30) | ~$9 Modal (owner go 2026-09-14 15:05) | running from 16:20; smoke ok (data validated: 73% filter keep, feature cross-checks pass, DFRC decodes); midway s1-190 vs v3b s1-200 at equal nodes +17 +/- 44 | the first new data source; attacks eval quality directly |
