...
| anna-v3q | v3b architecture at L1 = 256 (quarter width), same six months and schedule as v3b, from scratch | ~$4 Modal (owner go 2026-09-14 09:40) | running; s0-30 smoke ok; **speed measured on the s0-30 checkpoint: 227k vs 185k nodes/CPU-s for v3b (+23%; v1 458k)** at depth 11 on 30 positions | speed bet: v3 (1024) and v3b (512) were equal per node; +23% is ~+14 Elo at blitz if per-node strength holds. **Midway s1-90 vs v3b s1-100 at equal nodes: -53 +/- 42** (100 games): 256 looks like it loses per node, unlike the 1024->512 step; final decides |
