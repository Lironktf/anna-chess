...
| anna-v3q | v3b architecture at L1 = 256 (quarter width), same six months and schedule as v3b, from scratch | ~$4 Modal (owner go 2026-09-14 09:40) | running | speed bet: v3 (1024) and v3b (512) were equal per node |
